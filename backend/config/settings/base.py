...
# personal_website/
APPS_DIR = ROOT_DIR / "personal_website"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "personal_website.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "personal_website.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Tom Vo""", "tomvothecoder@gmail.com")]
...
WAGTAIL_SITE_NAME = "Tom Vo's Personal Website"
